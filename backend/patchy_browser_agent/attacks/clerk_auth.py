...
CLERK_SECRET_KEY_SAAPP = os.getenv("CLERK_SECRET_KEY_SAAPP")
...
async def _create_session(user_id: str) -> str:
    ...
    if not CLERK_SECRET_KEY_SAAPP:
        raise RuntimeError("CLERK_SECRET_KEY_SAAPP is not set")

    headers = {"Authorization": f"Bearer {CLERK_SECRET_KEY_SAAPP}"}
